...
namespace myLib
{
    public class myHotKey : Component, IDisposable
    {
        #region Constructor

        public myHotKey(IContainer container)
        {
            container.Add(this);
        ...
        protected void MessageEvent(object sender, ref Message msg, ref bool Handled)
        {
            if ((msg.Msg == (int)Messages.WM_HOTKEY) && (msg.WParam == (IntPtr)this.GetType().GetHashCode()))
            {
                Handled = true;
    ...
    public class NativeWindowWithEvent : NativeWindow
    {
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            {
                bool Handled = false;
                ProcessMessage(this, ref msg, ref Handled);

                if (!Handled) base.WndProc(ref msg);
            }
